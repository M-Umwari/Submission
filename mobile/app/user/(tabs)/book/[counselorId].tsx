            ...
            <ScrollView showsVerticalScrollIndicator={false} className="w-[90%]">
                <View className="w-full mt-8 mb-12">
                    <View className="w-full items-center">
                        ...
                        <Text className="font-ubuntuM text-xl mt-4">{counselor?.fullName}</Text>
                        <Text className="font-ubuntu text-base mt-2 text-custom-textGrey text-center">{counselor?.email}</Text>
                    </View>
