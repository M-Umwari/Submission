    ...
    return (
        <BottomSheetModalProvider>
            ...
            <View className="flex-1 items-center justify-center bg-white">
                <ScrollView showsVerticalScrollIndicator={false} className="w-full" contentContainerStyle={{alignItems:'center'}}>
                    <View className="w-[90%]">
                        ...
                        <View className="w-full mb-4 items-center">
                            ...
                            <Link push href='/counselor/settings/changePassword' asChild>
