...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 flex items-center justify-center w-full h-20 z-20 bg-white shadow-md">
            <div className='xs:w-[85%] md:w-[90%] flex items-center justify-between'>
                ...
                {toggleDropdown && <div 
                    className={`fixed top-28 flex flex-col items-center w-full bg-black bg-opacity-50`}
