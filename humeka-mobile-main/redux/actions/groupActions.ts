...
import { createGroupFormData, Group, groupFormData } from "@/types/Group";
...
export const leaveGroup = createAsyncThunk<Group, groupFormData>("group/leave", async (groupId, thunkAPI) => {
    try {
